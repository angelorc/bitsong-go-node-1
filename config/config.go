...
func DefaultConfig() *Config {
	...
	cfg.P2P.Seeds = "2d0fc898f8d21a9f4e76a9988f57c79bc289fd86@node-1.testnet.bitsong.network:26656"
...
func GetConfig() *Config {
	...
	cfg.SetRoot(utils.GetBitsongHome())
	EnsureRoot(utils.GetBitsongHome())
