...
import (
	"fmt"
	"github.com/BitSongOfficial/go-amino"
	...
	"github.com/BitSongOfficial/bitsong-go-node/rpc/lib/server"
	"github.com/rs/cors"
...
func RunApi(b *bitsong.Blockchain, tmRPC *rpc.Local) {
	client = tmRPC
	blockchain = b
	waitForTendermint()
