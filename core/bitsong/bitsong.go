...
import (
	...
	"github.com/BitSongOfficial/bitsong-go-node/core/appdb"
	"github.com/BitSongOfficial/bitsong-go-node/core/code"
	"github.com/BitSongOfficial/bitsong-go-node/core/rewards"
	"github.com/BitSongOfficial/bitsong-go-node/core/state"
	"github.com/BitSongOfficial/bitsong-go-node/core/transaction"
	"github.com/BitSongOfficial/bitsong-go-node/core/types"
	"github.com/BitSongOfficial/bitsong-go-node/core/validators"
	"github.com/BitSongOfficial/bitsong-go-node/eventsdb"
	"github.com/BitSongOfficial/bitsong-go-node/genesis"
	"github.com/BitSongOfficial/bitsong-go-node/helpers"
	"github.com/BitSongOfficial/bitsong-go-node/version"
	"github.com/BitSongOfficial/bitsong-go-node/rpc/lib/types"
...
// Main structure of BitSong Blockchain
...
// Creates BitSong Blockchain instance, should be only called once
func NewBitsongBlockchain() *Blockchain {
	ldb, err := db.NewGoLevelDB("state", utils.GetBitsongHome()+"/data")
	if err != nil {
		panic(err)
	}
...
// Return application info. Used for synchronization between Tendermint and Bitsong
...
func (app *Blockchain) Commit() abciTypes.ResponseCommit {
	// Committing Bitsong Blockchain state
...
// Gracefully stopping BitSong Blockchain instance
...
// Get immutable state of BitSong Blockchain
...
// Get immutable state of BitSong Blockchain for given height
...
// Get current height of BitSong Blockchain
func (app *Blockchain) Height() int64 {
	return atomic.LoadInt64(&app.height)
}

// Get last committed height of BitSong Blockchain
